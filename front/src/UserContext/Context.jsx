...
export default function AuthProvider({ children }) {
  ...
  async function auth_intra42() {
    const response = await axios.get(`http://10.13.10.18:8000/api/auth_intra/`, {
      withCredentials: true
    });
    try {
    ...
    try {
      ...
      if (code) {
        ...
        res = await axios.post(
          `http://10.13.10.18:8000/api/login/`,
          params,
          {
            withCredentials: true
          }
  ...
  async function get_auth_user() {
    try {
      const res = await axios.get(`http://10.13.10.18:8000/api/user/`, {
        withCredentials: true
      });
  ...
  async function Logout() {
    try {
      const res = await axios.get(`http://10.13.10.18:8000/api/logout/`, {
        withCredentials: true
      });
