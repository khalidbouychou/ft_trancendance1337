...
export var useLineChart = function (props) {
    ...
    var _330 = __read(useState(0), 2), scrollX = _330[0], setScrollX = _330[1];
    var _331 = __read(useState(''), 2), arrow1Points = _331[0], setArrow1Points = _331[1];
    var _332 = __read(useState(''), 2), arrow2Points = _332[0], setArrow2Points = _332[1];
    var _333 = __read(useState(''), 2), arrow3Points = _333[0], setArrow3Points = _333[1];
    var _334 = __read(useState(''), 2), arrow4Points = _334[0], setArrow4Points = _334[1];
    var _335 = __read(useState(''), 2), arrow5Points = _335[0], setArrow5Points = _335[1];
    var _336 = __read(useState(''), 2), secondaryArrowPoints = _336[0], setSecondaryArrowPoints = _336[1];
    var _337 = __read(useState(-1), 2), pointerIndex = _337[0], setPointerIndex = _337[1];
    var _338 = __read(useState(0), 2), pointerX = _338[0], setPointerX = _338[1];
    var _339 = __read(useState(0), 2), pointerY = _339[0], setPointerY = _339[1];
    var _340 = __read(useState(), 2), pointerItem = _340[0], setPointerItem = _340[1];
    var _341 = __read(useState(0), 2), pointerY2 = _341[0], setPointerY2 = _341[1];
    var _342 = __read(useState(), 2), pointerItem2 = _342[0], setPointerItem2 = _342[1];
    var _343 = __read(useState(0), 2), pointerY3 = _343[0], setPointerY3 = _343[1];
    var _344 = __read(useState(), 2), pointerItem3 = _344[0], setPointerItem3 = _344[1];
    var _345 = __read(useState(0), 2), pointerY4 = _345[0], setPointerY4 = _345[1];
    var _346 = __read(useState(), 2), pointerItem4 = _346[0], setPointerItem4 = _346[1];
    var _347 = __read(useState(0), 2), pointerY5 = _347[0], setPointerY5 = _347[1];
    var _348 = __read(useState([]), 2), pointerYsForDataSet = _348[0], setPointerYsForDataSet = _348[1];
    var _349 = __read(useState(), 2), pointerItem5 = _349[0], setPointerItem5 = _349[1];
    var _350 = __read(useState(0), 2), secondaryPointerY = _350[0], setSecondaryPointerY = _350[1];
    var _351 = __read(useState(), 2), secondaryPointerItem = _351[0], setSecondaryPointerItem = _351[1];
    var _352 = __read(useState([]), 2), pointerItemsForSet = _352[0], setPointerItemsForSet = _352[1];
    var _353 = __read(useState([]), 2), secondaryPointerItemsForSet = _353[0], setSecondaryPointerItemsForSet = _353[1];
    var _354 = __read(useState(0), 2), responderStartTime = _354[0], setResponderStartTime = _354[1];
    var _355 = __read(useState(false), 2), responderActive = _355[0], setResponderActive = _355[1];
    var _356 = __read(useState(''), 2), points = _356[0], setPoints = _356[1];
    var _357 = __read(useState(''), 2), points2 = _357[0], setPoints2 = _357[1];
    var _358 = __read(useState(''), 2), points3 = _358[0], setPoints3 = _358[1];
    var _359 = __read(useState(''), 2), points4 = _359[0], setPoints4 = _359[1];
    var _360 = __read(useState(''), 2), points5 = _360[0], setPoints5 = _360[1];
    var _361 = __read(useState(''), 2), secondaryPoints = _361[0], setSecondaryPoints = _361[1];
    var _362 = __read(useState(''), 2), fillPoints = _362[0], setFillPoints = _362[1];
    var _363 = __read(useState(''), 2), fillPoints2 = _363[0], setFillPoints2 = _363[1];
    var _364 = __read(useState(''), 2), fillPoints3 = _364[0], setFillPoints3 = _364[1];
    var _365 = __read(useState(''), 2), fillPoints4 = _365[0], setFillPoints4 = _365[1];
    var _366 = __read(useState(''), 2), fillPoints5 = _366[0], setFillPoints5 = _366[1];
    var _367 = __read(useState(''), 2), secondaryFillPoints = _367[0], setSecondaryFillPoints = _367[1];
    var _368 = __read(useState([]), 2), pointsFromSet = _368[0], setPointsFromSet = _368[1];
    var _369 = __read(useState([]), 2), fillPointsFromSet = _369[0], setFillPointsFromSet = _369[1];
    var _370 = __read(useState([]), 2), arrowPointsFromSet = _370[0], setArrowPointsFromSet = _370[1];
    var _371 = __read(useState((_o = props.focusedDataPointIndex) !== null && _o !== void 0 ? _o : -1), 2), selectedIndex = _371[0], setSelectedIndex = _371[1];
    useEffect(function () {
        var _a;
    ...
    var _372 = computeMaxAndMinItems(mergedPrimaryDataArrays, extrapolateMissingValues, roundToDigits, showFractionalValues, mergedPrimaryDataArraysOriginals), maxItem = _372.maxItem, minItem = _372.minItem;
    ...
    var secondaryRoundToDigits = (_114 = (_113 = props.secondaryYAxis) === null || _113 === void 0 ? void 0 : _113.roundToDigits) !== null && _114 !== void 0 ? _114 : (showSecondaryFractionalValues
        ...
        : 0);
    var _373 = computeMaxAndMinItems(mergedSecondaryDataArrays, extrapolateMissingValues, secondaryRoundToDigits, showSecondaryFractionalValues), secondaryMaxItem = _373.maxItem, secondaryMinItem = _373.minItem;
    ...
    var _374 = getAllArrowProperties(props, defaultArrowConfig), arrowLength1 = _374.arrowLength1, arrowWidth1 = _374.arrowWidth1, arrowStrokeWidth1 = _374.arrowStrokeWidth1, arrowStrokeColor1 = _374.arrowStrokeColor1, arrowFillColor1 = _374.arrowFillColor1, showArrowBase1 = _374.showArrowBase1, arrowLength2 = _374.arrowLength2, arrowWidth2 = _374.arrowWidth2, arrowStrokeWidth2 = _374.arrowStrokeWidth2, arrowStrokeColor2 = _374.arrowStrokeColor2, arrowFillColor2 = _374.arrowFillColor2, showArrowBase2 = _374.showArrowBase2, arrowLength3 = _374.arrowLength3, arrowWidth3 = _374.arrowWidth3, arrowStrokeWidth3 = _374.arrowStrokeWidth3, arrowStrokeColor3 = _374.arrowStrokeColor3, arrowFillColor3 = _374.arrowFillColor3, showArrowBase3 = _374.showArrowBase3, arrowLength4 = _374.arrowLength4, arrowWidth4 = _374.arrowWidth4, arrowStrokeWidth4 = _374.arrowStrokeWidth4, arrowStrokeColor4 = _374.arrowStrokeColor4, arrowFillColor4 = _374.arrowFillColor4, showArrowBase4 = _374.showArrowBase4, arrowLength5 = _374.arrowLength5, arrowWidth5 = _374.arrowWidth5, arrowStrokeWidth5 = _374.arrowStrokeWidth5, arrowStrokeColor5 = _374.arrowStrokeColor5, arrowFillColor5 = _374.arrowFillColor5, showArrowBase5 = _374.showArrowBase5, arrowLengthsFromSet = _374.arrowLengthsFromSet, arrowWidthsFromSet = _374.arrowWidthsFromSet, arrowStrokeWidthsFromSet = _374.arrowStrokeWidthsFromSet, arrowStrokeColorsFromSet = _374.arrowStrokeColorsFromSet, arrowFillColorsFromSet = _374.arrowFillColorsFromSet, showArrowBasesFromSet = _374.showArrowBasesFromSet;
    ...
    var _375 = __read(useState(-1), 2), selectedLineNumber = _375[0], setSelectedLineNumber = _375[1];
