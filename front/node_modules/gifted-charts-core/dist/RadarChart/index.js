...
export var useRadarChart = function (props) {
    ...
    var _u = props.circular, circular = _u === void 0 ? false : _u, _v = props.gridConfig, gridConfig = _v === void 0 ? {} : _v, _w = props.polygonConfig, polygonConfig = _w === void 0 ? {} : _w, _x = props.data, data = _x === void 0 ? [] : _x, dataSet = props.dataSet, _y = props.noOfSections, noOfSections = _y === void 0 ? radarChartDefaults.noOfSections : _y, _z = props.chartSize, chartSize = _z === void 0 ? radarChartDefaults.chartSize : _z, _0 = props.labelConfig, labelConfig = _0 === void 0 ? {} : _0, labelConfigArray = props.labelConfigArray, _1 = props.asterLinesConfig, asterLinesConfig = _1 === void 0 ? {} : _1, _2 = props.hideGrid, hideGrid = _2 === void 0 ? radarChartDefaults.hideGrid : _2, _3 = props.hideAsterLines, hideAsterLines = _3 === void 0 ? (_a = props.hideGrid) !== null && _a !== void 0 ? _a : radarChartDefaults.hideAsterLines : _3, _4 = props.dataLabelsConfig, dataLabelsConfig = _4 === void 0 ? {} : _4, _5 = props.labelsPositionOffset, labelsPositionOffset = _5 === void 0 ? radarChartDefaults.labelsPositionOffset : _5, _6 = props.dataLabelsPositionOffset, dataLabelsPositionOffset = _6 === void 0 ? radarChartDefaults.dataLabelsPositionOffset : _6, _7 = props.isAnimated, isAnimated = _7 === void 0 ? radarChartDefaults.isAnimated : _7, _8 = props.animationDuration, animationDuration = _8 === void 0 ? radarChartDefaults.animationDuration : _8, _9 = props.animateTogether, animateTogether = _9 === void 0 ? radarChartDefaults.animateTogether : _9;
    ...
    var _10 = gridConfig.stroke, gridStroke = _10 === void 0 ? radarChartDefaults.gridSection.stroke : _10, _11 = gridConfig.strokeWidth, gridStrokeWidth = _11 === void 0 ? radarChartDefaults.gridSection.strokeWidth : _11, _12 = gridConfig.strokeDashArray, gridStrokeDashArray = _12 === void 0 ? radarChartDefaults.gridSection
        .strokeDashArray : _12, _13 = gridConfig.fill, gridFill = _13 === void 0 ? radarChartDefaults.gridSection.fill : _13, _14 = gridConfig.gradientColor, gridGradientColor = _14 === void 0 ? radarChartDefaults.gridSection
        .gradientColor : _14, _15 = gridConfig.showGradient, gridShowGradient = _15 === void 0 ? radarChartDefaults.gridSection
        .showGradient : _15, _16 = gridConfig.opacity, gridOpacity = _16 === void 0 ? radarChartDefaults.gridSection.opacity : _16, _17 = gridConfig.gradientOpacity, gridGradientOpacity = _17 === void 0 ? radarChartDefaults.gridSection
        .gradientOpacity : _17;
    ...
    var _18 = labelConfig.fontSize, fontSize = _18 === void 0 ? radarChartDefaults.labelConfig.fontSize : _18, _19 = labelConfig.stroke, stroke = _19 === void 0 ? radarChartDefaults.labelConfig.stroke : _19, _20 = labelConfig.textAnchor, textAnchor = _20 === void 0 ? radarChartDefaults.labelConfig.textAnchor : _20, _21 = labelConfig.alignmentBaseline, alignmentBaseline = _21 === void 0 ? radarChartDefaults.labelConfig.alignmentBaseline : _21, _22 = labelConfig.fontWeight, fontWeight = _22 === void 0 ? radarChartDefaults.labelConfig.fontWeight : _22, _23 = labelConfig.fontFamily, fontFamily = _23 === void 0 ? radarChartDefaults.labelConfig.fontFamily : _23;
    var _24 = dataLabelsConfig.fontSize, dataLabelsFontSize = _24 === void 0 ? fontSize : _24, // defaults to labelConfig (from above)
    _25 = dataLabelsConfig.stroke, // defaults to labelConfig (from above)
    dataLabelsColor = _25 === void 0 ? stroke : _25, // defaults to labelConfig (from above)
    _26 = dataLabelsConfig.textAnchor, // defaults to labelConfig (from above)
    dataLabelsTextAnchor = _26 === void 0 ? textAnchor : _26, // defaults to labelConfig (from above)
    _27 = dataLabelsConfig.alignmentBaseline, // defaults to labelConfig (from above)
    dataLabelsAlignmentBaseline = _27 === void 0 ? alignmentBaseline : _27, // defaults to labelConfig (from above)
    _28 = dataLabelsConfig.fontWeight, // defaults to labelConfig (from above)
    dataLabelsFontWeight = _28 === void 0 ? fontWeight : _28, // defaults to labelConfig (from above)
    _29 = dataLabelsConfig.fontFamily // defaults to labelConfig (from above)
    , // defaults to labelConfig (from above)
    dataLabelsFontFamily = _29 === void 0 ? fontFamily : _29 // defaults to labelConfig (from above)
    ;
    var _30 = polygonConfig.stroke, polygonStroke = _30 === void 0 ? radarChartDefaults.polygonConfig.stroke : _30, _31 = polygonConfig.strokeWidth, polygonStrokeWidth = _31 === void 0 ? radarChartDefaults.polygonConfig
        .strokeWidth : _31, _32 = polygonConfig.strokeDashArray, polygonStrokeDashArray = _32 === void 0 ? radarChartDefaults.polygonConfig
        .strokeDashArray : _32, _33 = polygonConfig.fill, polygonFill = _33 === void 0 ? radarChartDefaults.polygonConfig.fill : _33, _34 = polygonConfig.gradientColor, polygonGradientColor = _34 === void 0 ? radarChartDefaults.polygonConfig
        .gradientColor : _34, _35 = polygonConfig.showGradient, polygonShowGradient = _35 === void 0 ? radarChartDefaults.polygonConfig
        .showGradient : _35, _36 = polygonConfig.opacity, polygonOpacity = _36 === void 0 ? radarChartDefaults.polygonConfig.opacity : _36, _37 = polygonConfig.gradientOpacity, polygonGradientOpacity = _37 === void 0 ? polygonOpacity : _37, showDataValuesAsLabels = polygonConfig.showDataValuesAsLabels, _38 = polygonConfig.isAnimated, polygonIsAnimated = _38 === void 0 ? isAnimated : _38, _39 = polygonConfig.animationDuration, polygonAnimationDuration = _39 === void 0 ? animationDuration : _39;
    ...
    var _40 = asterLinesConfig.stroke, asterLinesStroke = _40 === void 0 ? gridStroke : _40, _41 = asterLinesConfig.strokeWidth, asterLinesStrokeWidth = _41 === void 0 ? gridStrokeWidth : _41, _42 = asterLinesConfig.strokeDashArray, asterLinesStrokeDashArray = _42 === void 0 ? radarChartDefaults.asterLineStrokeDashArray : _42;
