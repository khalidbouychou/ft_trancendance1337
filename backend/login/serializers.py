...
class PlayerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Player
        fields = ['id', 'username', 'profile_name', 'avatar', 'status_network', 'two_factor', 'otp_verified', 'blocked_users', 'friends', 'ping_data' , 'tic_data' , 'bool_login', 'qrcode_path','is_anonimized']
