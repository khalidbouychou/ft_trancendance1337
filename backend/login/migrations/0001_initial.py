    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.URLField(default='https://i.pinimg.com/originals/5d/b5/b4/5db5b469edf32bb41f002482b784b894.png')),
                ('status_network', models.CharField(choices=[('online', 'online'), ('offline', 'offline')], default='offline', max_length=10)),
                ('two_factor', models.BooleanField(default=False)),
                ('otp_verified', models.BooleanField(default=False)),
                ('qrcode_path', models.CharField(default='', max_length=255)),
                ('bool_login', models.BooleanField(default=False)),
                ('mfa_secret', models.CharField(default='none', max_length=255)),
        ...
        migrations.CreateModel(
            name='AnonymizedAccount',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_name', models.CharField(default='Anonymized', max_length=200)),
                ('avatar', models.URLField(default='https://api.dicebear.com/9.x/thumbs/svg?flip=false')),
                ('status_network', models.CharField(choices=[('online', 'online'), ('offline', 'offline')], default='offline', max_length=10)),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='anonymized_data', to=settings.AUTH_USER_MODEL)),
            ],
            options={
