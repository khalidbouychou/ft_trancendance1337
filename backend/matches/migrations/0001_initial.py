    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('winner_profile_name', models.CharField(default='', max_length=100)),
                ('loser_profile_name', models.CharField(default='', max_length=100)),
                ('winner_avatar', models.URLField()),
                ('loser_avatar', models.URLField()),
